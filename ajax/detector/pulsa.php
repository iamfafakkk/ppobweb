...
?>
	...
	while ($data_service = mysqli_fetch_assoc($check_service)) {
	    ...
	    <!--<label class="col-4 alert alert-warning bd bd-warning" style="cursor: pointer;border: 2px solid #ffffff;border-radius: 35px;">
					<div class="rdiobox" style="width:100%">
						<input type="radio" name="layanan" value="<?php echo $data_service['service_id'];?>"><span><b> <?= $data_service['layanan']  ?></b></span>
							<div style="margin-top:20px;text-align:left; solid #fff;padding:1em;width:100%">
                ...
                <label class="col-12 alert alert-light bd bd-light" >
                    ...
                    <input type="radio" name="layanan" value="<?php echo $data_service['service_id'];?>"><span><b> <?= $data_service['layanan']  ?></b></span>
                        <div style="margin-top:10px;text-align:right; solid #fff;width:100%">
                            <b> Rp <?= number_format($data_service['harga'],0,',','.') ?></b>
